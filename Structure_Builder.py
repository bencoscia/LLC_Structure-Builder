...
for i in range(5, 143):  # searches relevant lines of text in file, f, being read
    ...
    positions_inp.append([x_values_inp[i - 5], y_values_inp[i - 5], z_values_inp[i - 5]])  # i - 5 since i starts at 5
